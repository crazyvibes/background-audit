...
### Added
- Publishing to Maven Central (`io.github.crazyvibes:background-audit`), alongside the
  existing JitPack coordinate. Wired up via the `com.vanniktech.maven.publish` plugin,
  with full POM metadata (developers, SCM) and a tag-triggered release workflow.
- Replaced the placeholder `LICENSE` with the full Apache License 2.0 text.
...
[Unreleased]: https://github.com/crazyvibes/background-audit/compare/v0.1.1...HEAD
[0.1.1]: https://github.com/crazyvibes/background-audit/compare/v0.1.0...v0.1.1
